...
- Integration with Modal Challenge
...
- Unit testing with Jest and integrated with Github Actions to run the tests after every Merge
- Dark/Ligth theme selector (Dark mode its also inspired by Hallowen colors)
...
### Jest
Jest is a testing framework for JavaScript/TypeScript, developed and maintained by Facebook. It is especially popular in the React ecosystem because of its zero-config configuration and powerful features. 
...
The application is deployed on Vercel **https://todo-jquery.vercel.app/details**.
The GitHub Repo is **https://github.com/jnahuel46/todo-jquery**.
The GitHub Actions screen is **https://github.com/jnahuel46/todo-jquery/actions**.
